namespace Docker.Registry.Client.Models
{
    ...
    public class ImageManifest2_1 : ImageManifest
    {
        ...
        /// <summary>
        /// architecture is the host architecture on which this image is intended to run. This is for information purposes and not
        ...
        /// <summary>
        /// history is a list of unstructured historical data for v1 compatibility. It contains ID of the image layer and ID of the
        /// layer’s parent layers.
        /// </summary>
        [DataMember(Name = "history")]
        public ManifestHistory[] History { get; set; }

        /// <summary>
        /// Signed manifests provides an envelope for a signed image manifest. A signed manifest consists of an image manifest
        /// along with an additional field containing the signature of the manifest.
